...
import { BookOpen, GraduationCap, BookMarked, Calendar } from "lucide-react"
...
export function OverviewCards({ selectedClass, subjectsCount }: OverviewCardsProps) {
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{selectedClass}th Standard</div>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
